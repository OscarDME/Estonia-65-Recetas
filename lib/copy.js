...
export const copy = {
  metadata: {
    title: "1000 tervislikku retsepti – suhkru- ja gluteenivabad",
    description:
  ...
  hero: {
    ...
    trustChips: [
      ...
      { icon: "🛡️", text: "Täna üle 75% soodsam" },
    ],
  },
  ...
  finalCta: {
    ...
    subUrgency:
      "Ära jäta kasutamata võimalust saada retseptiraamat üle 75% soodsamalt. Muuda oma tervist juba täna meie täieliku 365 päeva menüüga.",
  ...
  faq: {
    ...
    doesntWorkHeadline: "MIS EI TÖÖTA: ❌",
    doesntWork: [
    ...
    items: [
      { q: "KUIDAS MA RETSEPTID KÄTTE SAAN?", a: "Saad kogu sisu oma e-posti aadressile kohe pärast makse sooritamist." },
      { q: "KAS MA SAAN LIGIPÄÄSU KA TELEFONIST?", a: "Jah, saad retseptidele ligi nii telefonist, tahvelarvutist kui ka arvutist." },
  ...
  footer: {
    brand: "Crearis",
    copyright: "2026 © Kõik õigused kaitstud. Tutvu meie privaatsuspoliitikaga.",
  },
};